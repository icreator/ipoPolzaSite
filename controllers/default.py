...
def docs():
    ...
    h =CAT(
        ...
        UL(
        CAT(CAT(T('в ТОЧКА ПАО БАНКА "ФК ОТКРЫТИЕ"'), ' ',
                A(B(T('Оплатить')), _href='https://tochka.com/my/9cf0bf6f9859420490fa9d4ada2322a8', _target='blank'),
            UL(
            LI('к/с 30101810400000000225 в ОПЕРУ МОСКВА, г.МОСКВА'),
            LI(('БИК'), ' ', B('044525999')),
            #LI('ИНН 7707083893'),
            LI(T('р.счет'), ' ', B('40703810101500000148'))
            )) if True else CAT('')),
        CAT(CAT(T('в Московский ОАО “Сбербанк России”'),
            UL(
